...
<body>
            ...
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <div id="main-nav" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class="active" id="firstLink"><a href="index.php">Home</a></li>
    ...
    <div class="banner-container">
        ...
        <div class="logobox">
            ...
            <div class="logobutton"><input type="submit" id="submit" name="submit" class="logobutton" value="Sign In"></div>
        </form> -->
